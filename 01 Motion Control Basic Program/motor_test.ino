/**
 * @file motor_test.ino
 * @brief 电机驱动实验(motor driving program)
 ...
 *
 * [0] --|||--[1]       数字对应motorpwmPin[4]和motordirectionPin[4]索引号(The numbers correspond to the index numbers of motorpwmPin[4] and motordirectionPin[4])
...
void setup() {
  ...
  delay(1000);
  Velocity_Controller(45,50,0,0);  ///< 左前方移动(Move left forward)
  delay(1000);
  Velocity_Controller(90,50,0,0);  ///< 左移(Move left)
  delay(1000);
  Velocity_Controller(135,50,0,0); ///< 左后方移动(Move left backward)
  delay(1000);
  Velocity_Controller(180,50,0,0); ///< 后移(Move backward)
  delay(1000);
  Velocity_Controller(225,50,0,0); ///< 右后方移动(Move right backward)
  delay(1000);
  Velocity_Controller(270,50,0,0); ///< 右移(Move right)
  delay(1000);
  Velocity_Controller(315,50,0,0); ///< 右前方移动(Move right forward)
  delay(1000);
  Velocity_Controller(0, 0,50,0);  ///< 原地左转(Turn left in place)
  delay(1000);
  Velocity_Controller(0, 0,-50,0); ///< 原地右转(Turn right in place)
  delay(1000);
  Velocity_Controller(0,100,50,1);  ///< 漂移(Drift)
  delay(1000); 
