...
//读指定长度字节(Read specified length bytes)
...
//设置超声波rgb为呼吸灯模式(Set the ultrasonic RGB to breathing light mode)
//r1，g1，b1表示右边rgb灯的呼吸周期，例如20，20，20，表示2s一个周期(r1, g1, and b1 indicate the breathing cycle of the right RGB light, for example, 20, 20, 20, indicating a cycle of 2s)
//r2，g2，b2表示左边rgb灯的呼吸周期(r2, g2, and b2 indicate the breathing cycle of the left RGB light)
...
//设置超声波rgb灯的颜色(Set the color of the ultrasonic RGB light)
//r1，g1，b1表示右边rgb灯的三原色的比例，范围0-255(r1, g1, and b1 indicate the proportion of the three primary colors of the right RGB light, ranging from 0 to 255)
//r2，g2，b2表示左边rgb灯的三原色的比例，范围0-255(r2, g2, and b2 indicate the proportion of the three primary colors of the left RGB light, ranging from 0 to 255)
...
//获取超声波测得的距离单位mm(Get the distance measured by the ultrasonic wave in mm)
